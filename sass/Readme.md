...
folder are mapped to the application's root namespace, 'fr.ESIR.GreenVentory'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "fr.ESIR.GreenVentory"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'fr.ESIR.GreenVentory' in the same way
as `"fr.ESIR.GreenVentory/sass/src"`.
